...
- 100+ optimized functions intended for graphics projects

Heavily used in my [Path Tracer](https://github.com/mordori/miniRT)
...
Drop the ```lib_math.h``` in you includes directory and go crazy!
